...
// portrait orientation #define TFT_WIDTH  80
...
// designation #define TFT_CS   8  // Chip select control pin D8 #define TFT_DC
// D9  // Data Command control pin #define TFT_RST  PIN_D4  // Reset pin (could
// connect to NodeMCU RST, see next line) #define TFT_RST D0    // Set TFT_RST
// to -1 if the display RESET is connected to NodeMCU RST or 3.3V
...
// select #define TFT_CS   D5 // Chip select control pin to TFT CS #define
// TFT_DC   D6 // Data Command control pin to TFT DC (may be labelled RS =
// Register Select) #define TFT_RST  D7 // Reset pin to TFT RST (or RESET) OR
// alternatively, we can use STM32 port reference names PXnn #define TFT_CS PE11
// // Nucleo-F767ZI equivalent of D5 #define TFT_DC   PE9  // Nucleo-F767ZI
// equivalent of D6 #define TFT_RST  PF13 // Nucleo-F767ZI equivalent of D7
