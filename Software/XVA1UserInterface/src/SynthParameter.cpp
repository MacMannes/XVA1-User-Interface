...
SynthParameter& SynthParameter::numbers(
    const std::initializer_list<const int> numbers
) {
...
SynthParameter& SynthParameter::bitNumbers(
    const std::initializer_list<const int> bitNumbers
) {
...
SynthParameter& SynthParameter::descriptions(
    const std::initializer_list<const std::string> descriptions
) {
...
SynthParameter& SynthParameter::performanceControlType(
    const int paramNumber1, const int paramNumber2
) {
