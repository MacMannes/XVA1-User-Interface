...
class SynthParameter {
    ...
    std::string _name;
    // This will contain one or more parameter numbers (4 for XVA1 oscillators,
    // 8 for XFM2 operators, 2 for Performance controls),
...
public:
    ...
    SynthParameter& descriptions(
        std::initializer_list<const std::string> descriptions
    );
