...
Rotary mainRotaryEncoder = Rotary(D1, D2);
...
LEDButton shortcutButton1 =
    LEDButton(&mcp3, GPB7, GPB6, 1, &shortcutButtonChanged);
LEDButton shortcutButton2 =
    LEDButton(&mcp3, GPB5, GPB4, 2, &shortcutButtonChanged);
LEDButton shortcutButton3 =
    LEDButton(&mcp3, GPB3, GPB2, 3, &shortcutButtonChanged);
LEDButton shortcutButton4 =
    LEDButton(&mcp3, GPB1, GPB0, 4, &shortcutButtonChanged);
LEDButton shortcutButton5 =
    LEDButton(&mcp3, GPA0, GPA1, 5, &shortcutButtonChanged);
LEDButton shortcutButton6 =
    LEDButton(&mcp3, GPA2, GPA3, 6, &shortcutButtonChanged);
LEDButton shortcutButton7 =
    LEDButton(&mcp3, GPA4, GPA5, 7, &shortcutButtonChanged);
LEDButton shortcutButton8 =
    LEDButton(&mcp3, GPA6, GPA7, 8, &shortcutButtonChanged);

LEDButton* shortcutButtons [] = { &shortcutButton1, &shortcutButton2,
                                  &shortcutButton3, &shortcutButton4,
                                  &shortcutButton5, &shortcutButton6,
                                  &shortcutButton7, &shortcutButton8 };
...
Button* allButtons [] = { &menuButton,      &saveButton,      &escButton,
                          &shiftButton,     &shortcutButton1, &shortcutButton2,
                          &shortcutButton3, &shortcutButton4, &shortcutButton5,
                          &shortcutButton6, &shortcutButton7, &shortcutButton8,
                          &rotaryButton1,   &rotaryButton2,   &rotaryButton3,
                          &rotaryButton4,   &rotaryButton5,   &rotaryButton6,
                          &rotaryButton7,   &rotaryButton8,   &upButton,
                          &downButton };

Synthesizer synthesizer;
ParameterController parameterController = ParameterController(
    &synthesizer, &multiplexer, &tft, &display, &upButton, &downButton
);
